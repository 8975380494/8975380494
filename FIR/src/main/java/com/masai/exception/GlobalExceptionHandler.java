...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(FirNotFound.class)
	public ResponseEntity<MyError> DriverNotfound(FirNotFound ne, WebRequest wr){
	...
	public ResponseEntity<MyError> UserNotFound(MethodArgumentNotValidException ne, WebRequest wr){
	...
	public ResponseEntity<MyError> UserNotFound(Exception ne, WebRequest wr){
